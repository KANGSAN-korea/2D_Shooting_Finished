...
public class MeteoriteSpawner : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject meteroritePrefab;
    [SerializeField]
    ...
    private IEnumerator SpawnMeteorite()
    {
        while (true)
        {
            ...
            Vector3 meteoritePosition = new Vector3(positionX, stageData.LimMax.y - 1.0f, 0);
            Instantiate(meteroritePrefab, meteoritePosition, Quaternion.identity);
